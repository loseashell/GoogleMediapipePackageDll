...
typedef int (*FuncMediapipeHolisticTrackingDetectFrame)(int image_width, int image_height,int type, void* image_data,int* detect_result, void* detect_result_data);
...
public:
	...
	FuncMediapipeHolisticTrackingDetectFrame m_MediapipeHolisticTrackingDetectFrame;
