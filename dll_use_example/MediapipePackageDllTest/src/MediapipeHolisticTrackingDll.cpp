...
bool MediapipeHolisticTrackingDll::GetAllFunctions()
{
	if (m_DynamicModuleLoader.GetDynamicModuleState())
	{
		...
		void* pMediapipeHolisticTrackingDetectFrame = m_DynamicModuleLoader.GetFunction("MediapipeHolisticTrackingDetectFrame");
		if (pMediapipeHolisticTrackingDetectFrame != nullptr)
		{
			m_MediapipeHolisticTrackingDetectFrame = (FuncMediapipeHolisticTrackingDetectFrame)(pMediapipeHolisticTrackingDetectFrame);
			if (m_MediapipeHolisticTrackingDetectFrameDirect != nullptr)
			{
