...
typedef int (*Func_Mediapipe_Hand_Tracking_Detect_Frame)(int image_width,int image_height, int type,void* image_data, int* detect_result, void* detect_result_data);
