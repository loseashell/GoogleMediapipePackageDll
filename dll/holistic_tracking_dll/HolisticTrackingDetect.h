...
*/
	...
	public:
		...
		int DetectImage(int image_width, int image_height, int type, void* image_data, int* detect_result,void* detect_result_data);
	...
	private:
		...
		absl::Status Mediapipe_RunGraph_Direct(int image_width, int image_height, int type, void* image_data, int* detect_result,void* detect_result_data);
